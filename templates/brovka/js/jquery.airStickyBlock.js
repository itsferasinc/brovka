    ...
    $.fn.airStickyBlock = function(options){
        $.airStickyBlock = function($this, options){
            ...
            function setAmount(){
                ...
                stickyStop = stopBlockHeight + stopBlockOffset - stickyHeight; //+200
                // Отступ Sticky Block от начала координат
                stickyStart = stickyParentOffset + $this.position().top; // -85
                // Отступ Sticky Block от начала сайдбара при абсолютном позиционировании
                stickyAbsolute = stickyStop - stickyParentOffset; // +125
            } setAmount();
