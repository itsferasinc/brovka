...
<?
					if (intVal($res["LAST_MESSAGE_ID"]) > 0):
                        /*$arResult['AuthorName'] = ITSGlobal::getUserName($res['LAST_POSTER_ID']);*/
                        $arResult['AuthorName'] = $res["LAST_POSTER_NAME"];
					?>
						<div class="forum-lastpost-box">
							<span class="forum-lastpost-title"><?
								?><noindex><a rel="nofollow" href="<?=$res["URL"]["MESSAGE"]?>" title="<?=htmlspecialcharsbx($res["~TITLE"]." (".$arResult['AuthorName'].")")?>"><?
									?><?=$res["TITLE"]?> <span class="forum-lastpost-author">(<?=$arResult['AuthorName']//$res["LAST_POSTER_NAME"]?>)</span></a></noindex></span>
...
?>
						<div class="forum-lastpost-box">
							<span class="forum-lastpost-title">
                                <noindex>
                                    <a rel="nofollow" href="<?=$res["URL"]["MESSAGE"]?>" title="<?=htmlspecialcharsbx($res["~TITLE"]." (".$arResult['AuthorName'].")")?>">
                                        <?=$res["TITLE"]?> <span class="forum-lastpost-author">(<?=$arResult['AuthorName']?>)</span>
                                    </a>
                                </noindex>
                            </span>
							<span class="forum-lastpost-date"><?=$res["LAST_POST_DATE"]?></span>
