...
$arResult['RATING'] = CRatings::GetRatingVoteResult('FORUM_TOPIC', $arResult["TOPIC"]["ID"]);
...
?>
                                    ...
                                    <input onmousedown="this.form.type.value='topic';this.form.ACTION.value=this.form.ACTION_TOPIC.value;" type="submit" value="OK" />
								</div>
<?
else:
?>
