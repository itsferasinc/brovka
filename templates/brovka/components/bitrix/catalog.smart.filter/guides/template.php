		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<div class="row">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					?>
					<div class="col-lg-6 bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								default://CHECKBOXES
									?>
                                    <select class="select2guides" multiple name="<?=$arCur["CONTROL_NAME_ALT"]?>">
                                        <option>Все</option>
                                        <?foreach ($arItem["VALUES"] as $val => $ar){?>
                                            <option value="<?=$ar["HTML_VALUE_ALT"] ?>" <?echo $ar["CHECKED"]? 'selected="selected"':''?>>
                                                <?=$ar["VALUE"]?>
                                            </option>
                                        <?}?>
                                    </select>
